...
public class MyFirebaseMessageng extends FirebaseMessagingService {
    ...
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences("PRFS", MODE_PRIVATE);
    ...
    private void SendOreoNotification(RemoteMessage remoteMessage) {
        ...
        Notification.Builder builder = oreoNotification.getOreoNotification(title, body, pendingIntent, default_sound, icon);
        int i = 0;
        if (j > 0) {
            i = j;
        }
